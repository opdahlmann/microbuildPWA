...
{
    public class IssueMessageService : IIssueMessageService
    {
        private IIssueMessageRepository messageRepository;
        private IObjectsLocator ObjectLocator;
        private IIssueMessageRepository issueMessageRepository;

        public IssueMessageService(IDataUnitOfWork dataUnitOfWork, IObjectsLocator objectLocator)
        {
            this.messageRepository = dataUnitOfWork.IssueMessageRepository;
