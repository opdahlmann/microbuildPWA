...
{
    public class IssueMessageController : ApiController
    {
        private IObjectsLocator ObjectsLocator;

        public IssueMessageController(IObjectsLocator objectsLocator)
        {
   ...
   //     }
        ...
        [MicroBuildAuthorize]
        [HttpGet]
        [Route("projects/{projectId}/issuemessages")]
        public async Task<HttpResponseMessage> GetAllMessages(string projectId)
        {
            string userId = RequestContext.GetUserId();

			var company = await ObjectsLocator.CompanyService.GetUserCompaniesInProjectByUserId(projectId, userId);

			var messages = await ObjectsLocator.IssueMessageService.GetAllIssueMessages(projectId);
        ...
        {
            var messagePictureAsByteArray = await ObjectsLocator.IssueMessageService.GetIssueMessagePicture(issuemessageId);
